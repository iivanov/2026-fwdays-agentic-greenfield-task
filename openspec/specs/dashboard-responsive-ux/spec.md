# dashboard-responsive-ux Specification

## Purpose
Define the responsive browser dashboard contract for operational overview,
newsroom visual treatment, digest/flow/source status visibility, and Playwright
evidence across desktop and mobile layouts.
