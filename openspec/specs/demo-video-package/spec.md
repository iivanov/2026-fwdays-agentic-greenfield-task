# demo-video-package Specification

## Purpose
Define the repository-contained assets and workflows used to record the course demo video that shows the product and explains the agentic development process.
