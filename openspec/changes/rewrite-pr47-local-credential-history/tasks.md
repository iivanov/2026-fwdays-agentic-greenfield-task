...
- [ ] 1.2 Create and commit the OpenSpec plan for the targeted rewrite.

## 2. Rewrite and verify

- [ ] 2.1 Rewrite only the temporary clone's `main` history with an exact,
  non-logging replacement of the local fixture.
- [ ] 2.2 Verify the current tree is unchanged before process documentation and
