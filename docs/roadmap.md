...
| R-13 | AI processing worker: batch, near-dup grouping (n-gram Jaccard), truncation budget, OpenAI Responses API strict structured output, usage recording, `no_content` | R-11, R-09, R-12 | BR-FLOW-02..06, T-08, T-11, NFR-PERF-03, NFR-CON-02..03 | done |
| R-14 | Delivery workers: in-app, Brevo email, Telegram bot, Slack webhook, generic signed webhook; bounded retries + backoff + circuit breaker | R-11, R-10, R-13 | BR-DEL-02..05, T-10, NFR-REL-02..04, NFR-PERF-04, NFR-SEC-04..05 | done |
| R-15 | Feedback: thumbs up/down capture + reporting (no auto prompt change) | R-13 | BR-FLOW-08 | done |
...
| R-17 | Observability: structured logs + correlation ids, `OperationalEvent`, deduped Brevo operator alerts, AI usage/quota monitoring, fail-closed on free-tier exhaustion | R-11 | A-07, NFR-OPS-01..03, AT-10/12 | done |
| R-18 | Dashboard polish + responsive Playwright e2e for critical flows (digest history, run status, source warnings) | R-07..R-10, R-14 | NFR-UX-01, NFR-PERF-02, Q-04 | done |
| R-19 | Deploy config: `vercel.json` (SPA rewrites + security headers), Supabase deploy config, idempotent `infra/scripts/` bootstrap/audit — **human bootstrap gated** | R-03, R-18 | BR-PROJ-01..03, T-04, T-14, NFR-CON-04..08 | done |
| R-20 | Browser auth lifecycle: OAuth callback/session restoration, authenticated routing, logout, and responsive behavioral tests | R-05, R-18 | BR-USER-01, A-01, T-02/T-06, NFR-SEC-01, NFR-UX-01 | done |
